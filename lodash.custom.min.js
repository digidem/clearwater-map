...
return u},o.reject=function(n,r,t){return r=W(r,t),E(n,function(n,t,e){return!r(n,t,e)})},o.rest=C,o.shuffle=function(n){var r=-1,t=n?n.length:0,e=Array(typeof t=="number"?t:0);return N(n,function(n){var t=br(qr()*(++r+1));e[r]=e[t],e[t]=n}),e},o.sortBy=function(n,r,e){var u=-1,o=n?n.length:0,i=Array(typeof o=="number"?o:0);for(r=W(r,e),N(n,function(n,t,e){i[++u]={l:r(n,t,e),m:u,n:n}}),o=i.length,i.sort(t);o--;)i[o]=i[o].n;return i},o.tap=function(n,r){return r(n),n},o.throttle=function(n,r){function t(){i=new Date,a=null,u=n.apply(o,e)
...
if(typeof r!="number"&&null!=r){var o=u;for(r=W(r,t);o--&&r(n[o],o,n);)e++}else if(e=r,null==e||t)return n[u-1];return Rr.call(n,Fr(0,u-e))}},o.take=$,o.head=$,o.VERSION="1.3.1",H(o),o.prototype.chain=function(){return this.__chain__=!0,this},o.prototype.value=function(){return this.__wrapped__},N("pop push reverse shift sort splice unshift".split(" "),function(n){var r=vr[n];o.prototype[n]=function(){var n=this.__wrapped__;return r.apply(n,arguments),!Mr.spliceObjects&&0===n.length&&delete n[0],this
}}),N(["concat","join","slice"],function(n){var r=vr[n];o.prototype[n]=function(){var n=r.apply(this.__wrapped__,arguments);return this.__chain__&&(n=new i(n),n.__chain__=!0),n}}),cr&&!cr.nodeType?pr?(pr.exports=o)._=o:cr._=o:n._=o}(this);